...
class Channel(models.Model):
    ...
    nbr_iframe = fields.Integer(
        "Iframes", compute="_compute_slides_statistics", store=True
    )
...
class Slide(models.Model):
    ...
    slide_type = fields.Selection(
        selection_add=[("iframe", _("IFRAME"))], ondelete={"iframe": "set default"}
    )

    nbr_iframe = fields.Integer(
        "Number of Iframes", compute="_compute_slides_statistics", store=True
    )
