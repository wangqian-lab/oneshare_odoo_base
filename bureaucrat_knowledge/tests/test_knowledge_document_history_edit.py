...
class TestKnowledgeDocumentHistoryWrite(TestBureaucratKnowledgeBase):
    ...
    def test_document_restricted_access_write_user(self):
        ...
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
        with self.assertRaises(AccessError):
            self.document_subcat_2.latest_history_id.with_user(self.demo_user).unlink()
        with self.assertRaises(AccessError):
            self.document_subcat_2.latest_history_id.with_user(self.demo_user).write(
                {
                    "document_body_html": "Demo Document For Subcategory 2 e",
                }
            )

        self.document_subcat_2.write({"visibility_user_ids": [(4, self.demo_user.id)]})
    ...
    def test_document_restricted_editors_access_write_user(self):
        ...
        self.document_subcat_2.write({"editor_user_ids": [(4, self.demo_user.id)]})
    ...
    def test_document_restricted_editors_access_write_group(self):
        ...
        self.document_subcat_2.write({"editor_group_ids": [(4, self.group_demo.id)]})
    ...
    def test_document_restricted_owners_access_write_user(self):
        ...
        self.document_subcat_2.write({"owner_user_ids": [(4, self.demo_user.id)]})
    ...
    def test_document_restricted_owners_access_write_group(self):
        ...
        self.document_subcat_2.write({"owner_group_ids": [(4, self.group_demo.id)]})
    ...
    def test_document_public_access_write_user(self):
        self.assertEqual(self.document_subcat_2.visibility_type, "parent")
        self.assertEqual(
            (self.document_subcat_2.actual_visibility_category_id.visibility_type),
            "restricted",
        )
        ...
        with self.assertRaises(AccessError):
            self.document_subcat_2.latest_history_id.with_user(self.public_user).write(
                {"document_body_html": "Demo Document For Subcategory 2 e"}
            )
        with self.assertRaises(AccessError):
    ...
    def test_document_portal_access_write_user(self):
        ...
        with self.assertRaises(AccessError):
            self.document_subcat_2.latest_history_id.with_user(self.portal_user).write(
                {"document_body_html": "Demo Document For Subcategory 2 e"}
            )
        with self.assertRaises(AccessError):
            self.document_subcat_2.latest_history_id.with_user(
    ...
    def test_document_subcategory_2_restricted_access_write_user(self):
        ...
        self.assertFalse(
            (self.document_subcat_2.actual_visibility_category_id.visibility_group_ids)
        )
        self.assertFalse(
            (self.document_subcat_2.actual_visibility_category_id.visibility_user_ids)
        )
        self.assertFalse(self.document_subcat_2.visibility_group_ids)
        self.assertFalse(self.document_subcat_2.visibility_user_ids)
        ...
        self.category_top_level.write({"visibility_user_ids": [(4, self.demo_user.id)]})
    ...
    def test_document_subcategory_2_restricted_editors_access_write_user(self):
        ...
        self.assertFalse(
            (self.document_subcat_2.actual_visibility_category_id.editor_group_ids)
        )
        self.assertFalse(
            (self.document_subcat_2.actual_visibility_category_id.editor_user_ids)
        )
        self.assertFalse(self.document_subcat_2.editor_group_ids)
        self.assertFalse(self.document_subcat_2.editor_user_ids)
        ...
        self.category_top_level.write({"editor_user_ids": [(4, self.demo_user.id)]})

        self.assertEqual(len(self.category_top_level.editor_user_ids), 1)
        self.assertEqual(len((self.document_subcat_2.actual_editor_user_ids)), 1)
        self.DocHist.with_user(self.demo_user).create(
            {"document_type": "html", "document_id": self.document_subcat_2.id}
        )
        with self.assertRaises(AccessError):
        ...
        self.category_top_level.write({"editor_user_ids": [(3, self.demo_user.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
        ...
        self.category_subcat_1.write({"editor_user_ids": [(4, self.demo_user.id)]})
        ...
        self.category_subcat_1.write({"editor_user_ids": [(3, self.demo_user.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
        ...
        self.category_subcat_2.write({"editor_user_ids": [(4, self.demo_user.id)]})
        ...
        self.category_subcat_2.write({"editor_user_ids": [(3, self.demo_user.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
    ...
    def test_document_subcategory_2_restricted_editors_access_write_group(self):
        # pylint: disable=too-many-statements
        self.demo_user.groups_id |= self.group_demo
        ...
        self.category_top_level.write({"editor_group_ids": [(4, self.group_demo.id)]})
        ...
        self.category_top_level.write({"editor_group_ids": [(3, self.group_demo.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
        ...
        self.category_subcat_1.write({"editor_group_ids": [(4, self.group_demo.id)]})

        self.assertEqual(len(self.category_subcat_1.editor_group_ids), 1)
        self.assertEqual(len((self.document_subcat_2.actual_editor_group_ids)), 1)
        self.DocHist.with_user(self.demo_user).create(
            {"document_type": "html", "document_id": self.document_subcat_2.id}
        )
        with self.assertRaises(AccessError):
        ...
        self.category_subcat_1.write({"editor_group_ids": [(3, self.group_demo.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
        ...
        self.category_subcat_2.write({"editor_group_ids": [(4, self.group_demo.id)]})
        ...
        self.category_subcat_2.write({"editor_group_ids": [(3, self.group_demo.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
    ...
    def test_document_subcategory_2_restricted_owners_access_write_user(self):
        ...
        self.assertFalse(
            (self.document_subcat_2.actual_visibility_category_id.owner_group_ids)
        )
        self.assertEqual(
            len(self.document_subcat_2.actual_visibility_category_id.owner_user_ids), 0
        )
        self.assertFalse(self.document_subcat_2.owner_group_ids)
        self.assertEqual(len(self.document_subcat_2.owner_user_ids), 0)
        ...
        self.category_top_level.write({"owner_user_ids": [(4, self.demo_user.id)]})
        ...
        self.category_top_level.write({"owner_user_ids": [(3, self.demo_user.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
        ...
        self.category_subcat_1.write({"owner_user_ids": [(4, self.demo_user.id)]})
        ...
        self.category_subcat_1.write({"owner_user_ids": [(3, self.demo_user.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
        ...
        self.category_subcat_2.write({"owner_user_ids": [(4, self.demo_user.id)]})
        ...
        self.category_subcat_2.write({"owner_user_ids": [(3, self.demo_user.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
    ...
    def test_document_subcategory_2_restricted_owners_access_write_group(self):
        ...
        self.category_top_level.write({"owner_group_ids": [(4, self.group_demo.id)]})

        self.assertEqual(len(self.category_top_level.owner_group_ids), 1)
        self.assertEqual(len((self.document_subcat_2.actual_owner_group_ids)), 1)
        self.DocHist.with_user(self.demo_user).create(
            {"document_type": "html", "document_id": self.document_subcat_2.id}
        )
        self.document_subcat_2.latest_history_id.with_user(self.demo_user).write(
        ...
        self.category_top_level.write({"owner_group_ids": [(3, self.group_demo.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
        ...
        self.category_subcat_1.write({"owner_group_ids": [(4, self.group_demo.id)]})
        ...
        self.category_subcat_1.write({"owner_group_ids": [(3, self.group_demo.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
        ...
        self.category_subcat_2.write({"owner_group_ids": [(4, self.group_demo.id)]})
        ...
        self.category_subcat_2.write({"owner_group_ids": [(3, self.group_demo.id)]})
        with self.assertRaises(AccessError):
            self.DocHist.with_user(self.demo_user).create(
                {"document_type": "html", "document_id": self.document_subcat_2.id}
            )
