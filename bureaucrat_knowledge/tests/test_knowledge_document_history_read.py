...
class TestKnowledgeDocumentHistoryRead(TestBureaucratKnowledgeBase):
    ...
    def test_document_restricted_access_read_user(self):
        ...
        with self.assertRaises(exceptions.AccessError):
            self.document_subcat_2.latest_history_id.with_user(self.demo_user).read(
                ["document_body_html"]
            )
    ...
    def test_document_public_access_portal_internal_read_user(self):
        ...
        with self.assertRaises(exceptions.AccessError):
            self.document_subcat_2.latest_history_id.with_user(self.portal_user).read(
                ["document_body_html"]
            )
        with self.assertRaises(exceptions.AccessError):
            self.document_subcat_2.latest_history_id.with_user(self.public_user).read(
                ["document_body_html"]
            )
