...
class TestKnowledgeCategoryRead(TestBureaucratKnowledgeBase):
    ...
    def test_category_restricted_access_read_user(self):
        self.assertEqual(self.category_top_level.visibility_type, "restricted")
    ...
    def test_category_public_portal_internal_access_read_user(self):
        ...
        # Initial state
        self.assertEqual(self.category_top_level.visibility_type, "restricted")
        self.assertEqual(self.category_subcat_1.visibility_type, "parent")
        self.assertEqual(self.category_subcat_2.visibility_type, "parent")
        self.assertEqual(
            (self.category_subcat_2.actual_visibility_parent_id.visibility_type),
            "restricted",
        )
        ...
        self.assertEqual(
            self.category_top_level.with_user(self.demo_user).read(["name"])[0]["name"],
            "Top level category 1",
        )
        with self.assertRaises(exceptions.AccessError):
            self.category_top_level.with_user(self.public_user).read(["name"])
        ...
        self.assertEqual(
            self.category_subcat_1.with_user(self.demo_user).read(["name"])[0]["name"],
            "Subcategory 1",
        )
        with self.assertRaises(exceptions.AccessError):
            self.category_subcat_1.with_user(self.public_user).read(["name"])
        ...
        self.assertEqual(
            self.category_subcat_2.with_user(self.demo_user).read(["name"])[0]["name"],
            "Subcategory 2",
        )
        with self.assertRaises(exceptions.AccessError):
            self.category_subcat_2.with_user(self.public_user).read(["name"])
        ...
        self.assertEqual(
            self.category_top_level.with_user(self.portal_user).read(["name"])[0][
                "name"
            ],
            "Top level category 1",
        )
        ...
        self.assertEqual(
            self.category_subcat_1.with_user(self.portal_user).read(["name"])[0][
                "name"
            ],
            "Subcategory 1",
        )
        ...
        self.assertEqual(
            self.category_subcat_2.with_user(self.portal_user).read(["name"])[0][
                "name"
            ],
            "Subcategory 2",
        )
        ...
        self.assertEqual(
            self.category_top_level.with_user(self.public_user).read(["name"])[0][
                "name"
            ],
            "Top level category 1",
        )
        ...
        self.assertEqual(
            self.category_subcat_1.with_user(self.public_user).read(["name"])[0][
                "name"
            ],
            "Subcategory 1",
        )
        ...
        self.assertEqual(
            self.category_subcat_2.with_user(self.public_user).read(["name"])[0][
                "name"
            ],
            "Subcategory 2",
        )
    ...
    def test_subcategory_2_restricted_access_read_user(self):
        ...
        self.category_subcat_1.write({"visibility_user_ids": [(4, self.demo_user.id)]})
        ...
        self.category_subcat_1.write(
            {"visibility_user_ids": [(5, 0)], "visibility_type": "parent"}
        )
        self.env["bureaucrat.knowledge.category"].flush()
    ...
    def test_subcategory_2_restricted_access_read_group(self):
        ...
        self.category_subcat_1.write(
            {"visibility_group_ids": [(5, 0)], "visibility_type": "parent"}
        )
        self.env["bureaucrat.knowledge.category"].flush()
    ...
    def test_subcategory_2_restricted_editors_access_read_group(self):
        ...
        self.assertFalse(self.category_subcat_2.editor_group_ids)
        self.assertFalse(self.category_subcat_2.editor_user_ids)
        self.assertEqual(len(self.category_subcat_1.actual_editor_group_ids), 1)
        self.assertFalse(self.category_subcat_1.actual_editor_user_ids)
        self.assertEqual(len(self.category_subcat_2.actual_editor_group_ids), 1)
        self.assertFalse(self.category_subcat_2.actual_editor_user_ids)
