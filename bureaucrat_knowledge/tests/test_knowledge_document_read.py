...
class TestKnowledgeDocumentRead(TestBureaucratKnowledgeBase):
    ...
    def test_document_restricted_access_read_user(self):
        ...
        self.assertEqual(
            self.document_subcat_2.with_user(self.demo_user).read(["name"])[0]["name"],
    ...
    def test_document_public_access_portal_internal_read_user(self):
        ...
        self.assertEqual(
            self.document_subcat_2.with_user(self.portal_user).read(["name"])[0][
                "name"
            ],
            "Demo Document For Subcategory 2",
        )
        ...
        self.assertEqual(
            self.document_subcat_2.with_user(self.public_user).read(["name"])[0][
                "name"
            ],
            "Demo Document For Subcategory 2",
        )
