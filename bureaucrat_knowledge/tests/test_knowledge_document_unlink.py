...
class TestKnowledgeDocumentUnlink(TestBureaucratKnowledgeBase):
    ...
    def test_document_restricted_owners_access_unlink_user(self):
        ...
        document.write({"owner_user_ids": [(4, self.demo_user.id)]})
    ...
    def test_document_restricted_owners_access_unlink_group(self):
        ...
        document.write({"owner_group_ids": [(4, self.group_demo.id)]})
    ...
    def test_document_subcategory_2_restricted_editors_access_unlink_user(self):
        self.assertEqual(self.document_subcat_2.visibility_type, "parent")
        self.assertEqual(
            (self.document_subcat_2.actual_visibility_category_id.visibility_type),
            "restricted",
    ...
    def test_document_subcategory_2_restricted_editors_access_unlink_group(self):
        self.demo_user.groups_id |= self.group_demo
    ...
    def test_document_subcategory_2_restricted_owners_access_unlink_user(self):
        ...
        self.assertEqual(document_subcat_2.visibility_type, "parent")
        self.assertEqual(
            (document_subcat_2.actual_visibility_category_id.visibility_type),
            "restricted",
        )
        self.assertFalse(
            (document_subcat_2.actual_visibility_category_id.owner_group_ids)
        )
        self.assertEqual(
            len(document_subcat_2.actual_visibility_category_id.owner_user_ids), 0
        )
    ...
    def test_document_subcategory_2_restricted_owners_access_unlink_group(self):
        self.demo_user.groups_id |= self.group_demo
        ...
        self.assertEqual(len((document_subcat_2.actual_owner_group_ids)), 1)
        document_subcat_2.with_user(self.demo_user).unlink()
