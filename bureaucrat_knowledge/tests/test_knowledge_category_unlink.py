...
class TestKnowledgeCategoryUnlink(TestBureaucratKnowledgeBase):
    ...
    def test_category_restricted_owners_access_unlink_user(self):
        ...
        category = Category.create({"name": "Test top level category"})
        ...
        category.write({"owner_user_ids": [(4, self.demo_user.id)]})
    ...
    def test_category_restricted_owners_access_write_group(self):
        ...
        category.write({"owner_group_ids": [(4, self.group_demo.id)]})
    ...
    def test_subcategory_2_restricted_owners_access_unlink_user(self):
        Category = self.env["bureaucrat.knowledge.category"]
        category_top_level = Category.create({"name": "Test top level category "})
        ...
        self.assertEqual(category_top_level.visibility_type, "restricted")
        self.assertEqual(category_subcat_1.visibility_type, "parent")
        self.assertEqual(category_subcat_2.visibility_type, "parent")
        self.assertEqual(
            (category_subcat_2.actual_visibility_parent_id.visibility_type),
            "restricted",
        )
        ...
        category_top_level.write({"owner_user_ids": [(4, self.demo_user.id)]})
    ...
    def test_subcategory_2_restricted_owners_access_unlink_group(self):
        ...
        category_top_level.write({"owner_group_ids": [(4, self.group_demo.id)]})
