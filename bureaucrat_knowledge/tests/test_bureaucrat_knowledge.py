...
class TestBureaucratKnowledge(TestBureaucratKnowledgeBase):
    def test_category_default_values(self):
        ...
        category.write({"editor_user_ids": [(6, 0, [self.demo_user.id])]})
    ...
    def test_document_search_by_index_field(self):
        ...
        self.assertIn(
            "Lorem Ipsum", self.document_subcat_2_with_pdf._get_document_index()
        )
        documents = Document.search([("index_document_body", "ilike", "lorem ipsum")])
