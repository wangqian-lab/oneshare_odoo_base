...
class ResConfigSettings(models.TransientModel):
    ...
    app_system_name = fields.Char(
        "System Name", help="Setup System Name,which replace Odoo"
    )
    ...
    app_show_enterprise = fields.Boolean(
        "Show Enterprise Tag", help="Uncheck to hide the Enterprise tag"
    )
    app_show_share = fields.Boolean(
        "Show Share Dashboard", help="Uncheck to hide the Odoo Share Dashboard"
    )
    app_show_poweredby = fields.Boolean(
        "Show Powered by Odoo", help="Uncheck to hide the Powered by text"
    )
    ...
    def get_values(self):
        ...
        app_system_name = ir_config.get_param(
            "app_system_name", default="Onesphere - Open Source MOM"
        )

        app_show_lang = strtobool(ir_config.get_param("app_show_lang", default="True"))
        app_show_debug = strtobool(
            ir_config.get_param("app_show_debug", default="False")
        )
        app_show_documentation = strtobool(
            ir_config.get_param("app_show_documentation", default="False")
        )
        app_show_documentation_dev = strtobool(
            ir_config.get_param("app_show_documentation_dev", default="False")
        )
        app_show_support = strtobool(
            ir_config.get_param("app_show_support", default="False")
        )
        app_show_account = strtobool(
            ir_config.get_param("app_show_account", default="False")
        )
        app_show_enterprise = strtobool(
            ir_config.get_param("app_show_enterprise", default="False")
        )
        app_show_share = strtobool(
            ir_config.get_param("app_show_share", default="False")
        )
        app_show_poweredby = strtobool(
            ir_config.get_param("app_show_poweredby", default="False")
        )
        ...
        app_support_url = ir_config.get_param(
            "app_support_url", default="https://www.oneshare.com.cn/trial/"
        )
        app_account_title = ir_config.get_param(
            "app_account_title", default="My Online Account"
        )
        app_account_url = ir_config.get_param(
            "app_account_url", default="https://www.oneshare.com.cn/my-account/"
        )
        app_enterprise_url = ir_config.get_param(
            "app_enterprise_url", default="https://www.oneshare.com.cn"
        )
        app_ribbon_show = strtobool(
            ir_config.get_param("app_ribbon_show", default="False")
        )
        app_ribbon_name = ir_config.get_param(
            "app_ribbon_name", default="*Oneshare.com.cn"
        )
        res.update(
    ...
    def set_values(self):
        ...
        ir_config.set_param(
            "app_show_documentation", str(self.app_show_documentation) or "False"
        )
        ir_config.set_param(
            "app_show_documentation_dev", self.app_show_documentation_dev or "False"
        )
        ...
        ir_config.set_param(
            "app_show_enterprise", str(self.app_show_enterprise) or "False"
        )
        ir_config.set_param("app_show_share", str(self.app_show_share) or "False")
        ir_config.set_param(
            "app_show_poweredby", str(self.app_show_poweredby) or "False"
        )

        ir_config.set_param(
            "app_documentation_url",
            self.app_documentation_url
            or "https://www.oneshare.com.cn/documentation/user/14.0/en/index.html",
        )
        ir_config.set_param(
            "app_documentation_dev_url",
            self.app_documentation_dev_url
            or "https://www.oneshare.com.cn/documentation/14.0/index.html",
        )
        ir_config.set_param(
            "app_support_url",
            self.app_support_url or "https://www.oneshare.com.cn/trial/",
        )
        ir_config.set_param(
            "app_account_title", self.app_account_title or "My Online Account"
        )
        ir_config.set_param(
            "app_account_url",
            self.app_account_url or "https://www.oneshare.com.cn/my-account/",
        )
        ir_config.set_param(
            "app_enterprise_url",
            self.app_enterprise_url or "https://www.oneshare.com.cn",
        )
        ir_config.set_param("app_ribbon_show", str(self.app_ribbon_show) or "False")
        ir_config.set_param(
            "app_ribbon_name", self.app_ribbon_name or "*oneshare.com.cn"
        )
    ...
    def remove_account_chart(self):
        ...
        try:
            ...
            _logger.error(
                "remove data error: %s,%s",
                "account_chart: set tax and account_journal",
                e,
            )
    ...
    def reset_cat_loc_name(self):
        ids = self.env["product.category"].search(
            [("parent_id", "!=", False)], order="complete_name"
        )
        for rec in ids:
            try:
