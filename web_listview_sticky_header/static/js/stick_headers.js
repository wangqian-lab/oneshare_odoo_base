odoo.define(
  "ks_odoo11_web_listview_sticky_header.stick_header",
  function (require) {
    "use strict";
    ...
    ListView.include({
      _freezeColumnWidths: function () {
        if (
          this.getParent() &&
          this.getParent().$el &&
          (this.getParent().$el.hasClass("o_field_one2many") !== false ||
            this.getParent().$el.hasClass("o_field_many2many") !== false)
        ) {
      ...
      _onCellClick: function (event) {
        ...
        if (
          !this._isRecordEditable($tr.data("id")) ||
      ...
      on_attach_callback: function () {
        ...
        $("div.modal-footer a").bind("click", function () {
          if (
            $(this).prop("href").split("/.")[1] &&
            $(this).prop("href").split("/.")[1] === "o_onboarding_container"
          ) {
            setTimeout(function () {
              if (
                $(".o_content").length &&
                $(".o_content").offset().top + 1 !=
                  $(".tableFloatingHeaderOriginal").css("top")
              ) {
                $(".tableFloatingHeaderOriginal").css(
                  "top",
                  $(".o_content").offset().top + 0.5
                );
              }
            }, 400);
          }
