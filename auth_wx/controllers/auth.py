...
class AuthWx(http.Controller):
    ...
    def wechat_app_login(self, provider, *args, **kw):
        ...
        WechatClient = CloudProvider(
            WechatProvider, app_id=wx_app_id, secret_key=wx_app_secret
        )
        ...
        ret = {
            ...
            "image_small": "data:{0};base64,{1}".format(
                "image/png", user_id.image_128.decode()
            )
            if user_id.image_128
            else "",
